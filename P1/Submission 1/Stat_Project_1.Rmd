...
obesity_data$Obesity_Binary <- ifelse(obesity_data$NObeyesdad == "Normal_Weight", 0, 1)
...
> Marginally Significant: 
  FCVC (Vegetable Intake): Has a small positive effect (p = 0.058).

> Not Significant:
  Age: No clear impact (p = 0.247).
...
>  **Top Predictors** : Weight and Height are the most important factors collected for classification. After Weight and Height, Age, FCVC, TUE, and FAF appear to have a weaker influence.Key
